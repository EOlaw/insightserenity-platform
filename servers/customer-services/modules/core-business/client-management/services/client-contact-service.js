    ...
    async searchContacts(filters = {}, options = {}) {
        try {
            ...
            if (filters.department) {
                query['professionalInfo.department'] = { $regex: filters.department, $options: 'i' };
            }
            ...
            if (filters.search) {
                query.$or = [
                    ...
                    { contactId: { $regex: filters.search, $options: 'i' } }
                ];
            }
            ...
            return {
                contacts: contacts.map(c => this._sanitizeContactOutput(c)),
                pagination: {
                    total,
                    page,
                    limit,
