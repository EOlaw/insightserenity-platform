...
// Create schema
const clientDocumentSchema = BaseModel.createSchema(clientDocumentSchemaDefinition, {
...
// ==================== Create Model ====================
const ClientDocumentModel = BaseModel.createModel('ClientDocument', clientDocumentSchema, {
  collection: 'client_documents',
...
module.exports = ClientDocumentModel;