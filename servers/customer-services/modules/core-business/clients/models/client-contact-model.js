...
// Create schema
const clientContactSchema = BaseModel.createSchema(clientContactSchemaDefinition, {
...
// ==================== Create Model ====================
const ClientContactModel = BaseModel.createModel('ClientContact', clientContactSchema, {
  collection: 'client_contacts',
...
module.exports = ClientContactModel;