...
export default function NoteDetailPage() {
    ...
    const loadNote = async () => {
        ...
        try {
            ...
            // Fix: Extract note directly from response.data
                            ...
                            <CardContent className="space-y-3">
                                <div>
                                    ...
                                    <p className="text-sm text-gray-900">
                                        {typeof note.metadata?.createdBy === 'object'
                                            ? `${note.metadata.createdBy.profile?.firstName || ''} ${note.metadata.createdBy.profile?.lastName || ''}`.trim() || 'Unknown'
                                            : note.metadata?.createdBy || 'Unknown'}
                                    </p>
                                </div>
