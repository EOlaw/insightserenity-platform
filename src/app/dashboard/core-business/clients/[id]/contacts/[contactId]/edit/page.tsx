...
export default function EditContactPage() {
  ...
  const loadContact = async () => {
    ...
    try {
      ...
      setFormData({
        ...
        primaryEmail: contact.communicationChannels?.email?.primary || '',
        secondaryEmail: contact.communicationChannels?.email?.secondary || '',
        primaryPhone: contact.communicationChannels?.phone?.primary || '',
        mobilePhone: contact.communicationChannels?.phone?.mobile || '',
        directPhone: contact.communicationChannels?.phone?.direct || '',
        workAddress: contact.communicationChannels?.address?.work || '',
        linkedin: contact.communicationChannels?.socialMedia?.linkedin || '',
        twitter: contact.communicationChannels?.socialMedia?.twitter || '',
        ...
        decisionMakingLevel: contact.roleInfluence?.decisionMakingLevel || '',
        influenceScore: contact.roleInfluence?.influenceScore?.toString() || '',
        notes: '',
      })
    } catch (err: any) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const errorMessage = err.response?.data?.error?.message || err.message || 'Failed to update contact'
